...
import { Loader2, Search, Trash2, CheckCircle2, MessageCircle, AlertCircle } from "lucide-react";
...
export default function CounselorRequestsAdminPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="mb-8">
        <h1 className="text-3xl font-serif font-bold text-stone-900 mb-2">Counselor Session Requests</h1>
        <p className="text-stone-500">Manage incoming requests from the Partnership Circle.</p>
      </div>
